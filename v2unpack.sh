...
xargs -P 4 -I {} v2dat unpack geosite -o "original/geosite" -f {} "db/geosite.dat" < geosite_categories.list

sing-box geoip list -f db/geoip.db | awk '{print $1}' | sort > geoip_categories.list
xargs -P 4 -I {} v2dat unpack geoip -o "original/geoip" -f {} "db/geoip.dat" < geoip_categories.list
